...
const Navigation = ({ navigation, route, options }) => {
    ...
    if(!canGoBack || main){
        return <SafeAreaView style={styles.header}>
            ...
            <View style={styles.brand}>
                <Title darkTheme font="title1" style={{textAlign: 'center'}}>Esom</Title>
            </View>
        </SafeAreaView>
    }
    ...
    return <SafeAreaView style={styles.header}>
        <TouchableOpacity style={styles.goBack} onPress={navigation.goBack}>
            <Ionicons name="chevron-back" size={30} color={iOSColors.white}/>
            <Title darkTheme font="headline">Back</Title>
        </TouchableOpacity>
    </SafeAreaView>
}
